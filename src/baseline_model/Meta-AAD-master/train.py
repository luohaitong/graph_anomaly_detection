...
def argsparser():
    ...
    parser.add_argument('--train', help='Training datasets', default='DGraphFin')
    parser.add_argument('--test', help='Testing datasets', default='DGraphFin')
...
def train(args):
    ...
    for d in train_datasets:
        datapaths.append(os.path.join('../../data/', d+'/binary_label/train_set.csv'))
    ...
    for d in test_datasets:
        path = os.path.join('../../data/', d + '/binary_label/test_set.csv')
    ...
    model.save(os.path.join(args.log, 'model_DGraphFin'))
