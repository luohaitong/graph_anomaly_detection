...
flags.DEFINE_integer('num_items', 857899, 'Number of items.')
flags.DEFINE_integer('num_cats', 2, 'Number of categories.')
flags.DEFINE_integer('num_PA', 3, 'Number of PA levels.')
flags.DEFINE_string('price_format', 'absolute', 'Price format.')
flags.DEFINE_integer('feature_size', 17, 'feature size for original features.')
...
flags.DEFINE_integer('batch_size', 124, 'Batch Size.')
...
flags.DEFINE_string('datafile_prefix', '../data/DGraphFin/', 'Path prefix to data files.')
